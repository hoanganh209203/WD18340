...
<footer className="bg-white rounded-lg shadow dark:bg-gray-900 m-4">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            <NavLink to={'/'} className="flex justify-center items-center gap-6 mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                <img src="https://static.ybox.vn/2023/10/4/1696481102579-thao29o9x4co-avatar.png" className="h-28 w-full" alt="Flowbite Logo" />
                <span className="self-center text-3xl font-bold whitespace-nowrap text-black">Anhlthph29890</span>
            </NavLink>
