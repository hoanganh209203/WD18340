...
const Login = (props: Props) => {
  return (
    ...
    <div className="relative flex items-center">
      <input type="email" placeholder="Enter Email" className="px-4 py-3 bg-[#f0f1f2] w-full text-sm border outline-[#007bff] rounded" />
    ...
    <div className="relative flex items-center">
      <input type="password" placeholder="Enter Password" className="px-4 py-3 bg-[#f0f1f2] w-full text-sm border outline-[#007bff] rounded" />
    ...
    <button type="button" className="px-6 py-2 w-full !mt-8 text-sm font-semibold bg-[#007bff] text-white rounded active:bg-[#006bff]">Submit</button>
  </form>
