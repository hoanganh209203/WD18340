...
const AddProduct_Demon = ({onAdd}: Props) => {
    ...
    return (
    <form className="font-[sans-serif] max-w-4xl mx-auto" onSubmit={handleSubmit(onSubmit)}>
  <div className="grid sm:grid-cols-2 gap-6">
    ...
    <div className="relative flex items-center">
      <input type="description" placeholder="Descriptions"
  ...
  <button type="submit" className="mt-8 px-6 py-2.5 text-sm w-full font-semibold bg-[#007bff] text-white rounded hover:bg-[#006bff]">Submit</button>
</form>

  )
}

export default AddProduct_Demon