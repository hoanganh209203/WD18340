          ...
          <div className="flex gap-[70px] mt-20">
            ...
            <div>
              ...
              <div className="flex flex-row gap-4">
                ...
                >
                  <img className="w-[100px] h-[100px] object-cover" key={index} src={imageUrl} alt={`Image ${index + 1}`} />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-8 gap-5">
                <div className="flex items-center">
                  ...
                  />
                  <button
                    className="w-10 h-11 border border-red-500 rounded-r-[4px] bg-red-500"
                  >
                    <svg
                      className="m-auto"
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  className="w-[165px] font-medium text-white bg-red-500 rounded-[4px] h-11"
                >
                  Buy Now
                </button>
              ...
              <div className="mt-10 w-full border border-black/50 rounded">
                ...
                <div
                  className="flex items-center px-4 h-[90px] gap-4 border-t border-black/50"
                >
                  <div>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="">
                    ...
                    >Free 30 Days Delivery Returns.
                      <span className="underline">Details</span></span>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div className="p-6 lg:max-w-7xl max-w-2xl max-lg:mx-auto">
    <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-12">
      <div className="lg:col-span-3 bg-gray-100 w-full lg:sticky top-0 text-center p-8">
        <img src={product?.thumbnail} alt="Product" className="w-4/5 h-4/6 rounded object-cover" />
        <hr className="border-white border-2 my-6" />
        <div className="flex flex-wrap gap-x-12 gap-y-6 justify-center mx-auto">
        {product?.images && product.images.map((imageUrl, index) => (
          <img key={index} src={imageUrl} alt={`Image ${index + 1}`} className="w-20 cursor-pointer" />
         ))}
        </div>
      </div>
      <div className="lg:col-span-2">
        ...
        <div className="mt-8">
          <h3 className="text-lg font-bold text-gray-800">{product?.category?.name}</h3>
          <ul className="space-y-3 list-disc mt-4 pl-4 text-sm text-gray-800">
            <li>Hãng:{product?.brand}</li>
            <li>Giảm giá:{product?.discountPercentage}%</li>
            <li>Mô tả:{product?.description}</li>
          </ul>
        </div>
        <div className="mt-8 max-w-md">
          <h3 className="text-lg font-bold text-gray-800">Reviews({product?.rating})</h3>
